...
namespace Tools
{
    public class ProceduralFeetHolder : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject rayPointsParent;
        [SerializeField] private const float localFrontZ = 1.73f;
        [SerializeField] private const float localBackZ = -1.73f;

        [Range(1, 4)] public int AmountOfFeetPerSide = 2;
        ...
        public void CreateFeet()
        {
            ...
            if (AmountOfFeetPerSide > 1)
            {
                ...
                for (int i = 0; i < AmountOfFeetPerSide; i++)
                {
                    ...
                    newFeet.transform.localPosition = new Vector3(newFeet.transform.localPosition.x,
                        newFeet.transform.localPosition.y, localZ);
